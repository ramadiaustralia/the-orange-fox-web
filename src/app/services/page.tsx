...
export default function ServicesPage() {
  ...
  const services = [
    { num: '01', icon: '🌐', titleKey: 'svc_web_title' as const, descKey: 'svc_web_desc' as const, features: ['Responsive Design', 'Next.js & React', 'Performance Optimized', 'SEO Ready'] },
    { num: '02', icon: '⚡', titleKey: 'svc_admin_title' as const, descKey: 'svc_admin_desc' as const, features: ['Custom Dashboard', 'Role Management', 'Real-time Analytics', 'Content Editor'] },
    { num: '03', icon: '🔒', titleKey: 'svc_domain_title' as const, descKey: 'svc_domain_desc' as const, features: ['Domain Registration', 'SSL Certificate', 'Cloud Hosting', 'CDN Setup'] },
    { num: '04', icon: '📈', titleKey: 'svc_seo_title' as const, descKey: 'svc_seo_desc' as const, features: ['On-page SEO', 'Google Analytics', 'Payment Gateway', 'API Integration'] },
    { num: '05', icon: '📚', titleKey: 'svc_training_title' as const, descKey: 'svc_training_desc' as const, features: ['Video Tutorials', 'User Manual', 'Live Training', 'Q&A Support'] },
    { num: '06', icon: '🛡️', titleKey: 'svc_support_title' as const, descKey: 'svc_support_desc' as const, features: ['24/7 Monitoring', 'Security Patches', 'Bug Fixes', 'Feature Updates'] },
  ];
            ...
            <ScrollReveal key={i} delay={i * 0.1}>
              <div className="bg-white border border-border-light rounded-2xl p-7 transition-all duration-400 hover:-translate-y-1.5 hover:shadow-[0_20px_60px_rgba(212,105,42,0.08)] hover:border-orange/30 h-full">
                ...
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-orange/10 flex items-center justify-center text-lg">{svc.icon}</div>
