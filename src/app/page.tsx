...
export default function Home() {
  ...
  const services = [
    { icon: '🌐', titleKey: 'svc_web_title' as const, descKey: 'svc_web_desc' as const },
    { icon: '⚡', titleKey: 'svc_admin_title' as const, descKey: 'svc_admin_desc' as const },
    { icon: '🔒', titleKey: 'svc_domain_title' as const, descKey: 'svc_domain_desc' as const },
    { icon: '📈', titleKey: 'svc_seo_title' as const, descKey: 'svc_seo_desc' as const },
    { icon: '📚', titleKey: 'svc_training_title' as const, descKey: 'svc_training_desc' as const },
    { icon: '🛡️', titleKey: 'svc_support_title' as const, descKey: 'svc_support_desc' as const },
  ];
