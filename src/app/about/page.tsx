    ...
    <>
      ...
      <section className="relative bg-gradient-to-br from-dark via-dark-soft to-charcoal px-6 py-24 md:py-32 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <Image src="/images/logo-fox.png" alt="The Orange Fox" width={120} height={120} className="mx-auto mb-6 w-24 h-auto" style={{ animation: 'heroFloat 7s ease-in-out infinite' }} />
